...
public class server extends JFrame implements MouseListener
{
   ...
   public void initcomponent()
     {
                    ...
                    setLayout(null);
                    serverstart.setBounds(95,70,150,40);
                    add(serverstart);
                    ...
                    stopserver.setBounds(95,140,150,40);
    ...
    this.addWindowListener(new WindowAdapter()
                {
                    public void windowClosing(WindowEvent e)
                   {
                       ...
                       if(serverOn==true)  {
                            ...
                            System.out.println("Server stopped");
                            serverSocket.close();
                            //socket.close();// Due to this exception is occuring in the thread 
                            t.stop();
                        }
                       }
                       catch(Exception ex){
  ...
  public server() {
    ...
    String DB_URL = "jdbc:mysql://localhost/stud";
                String USER = "hs";
    String PASS = "1234";
